...
<section id="venues">
  ...
  <p>It is mid-2026, so anything with a spring-2026 deadline is already closed. Every venue below has
  a <b>deadline that is still ahead</b>, listed soonest first. Some dates are confirmed; for the
  others (mostly the 2027 editions of the games and RL conferences) the exact date is not posted yet,
  so we give the expected window based on prior years and mark it clearly. The games and RL
  conferences (CoG, RLC, AIIDE, CoLLAs) are the best fit for the work; the sooner deadlines (AAAI,
  the NeurIPS and ICLR workshops, AAMAS) just get you in front of people first.</p>
  ...
  <table style="font-size:13px;">
    ...
    <tr>
      ...
      <td>ICLR style, 9 to 10 pp; double-blind; OpenReview</td>
      <td class="good">yes</td>
    </tr>
    <tr>
      <td><b>4</b></td>
    ...
    <tr>
      ...
      <td>CoLLAs single-column, 9 pp + unlimited refs; double-blind; OpenReview</td>
      <td class="good">yes</td>
    </tr>
    <tr>
      <td><b>7</b></td>
      ...
      <td>RLC style, 8 rec / 12 max pp; double-blind; OpenReview; published in RLJ</td>
      <td class="good">yes</td>
    </tr>
    <tr>
      <td><b>8</b></td>
