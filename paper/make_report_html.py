...
<section id="venues">
  ...
  shortlist of five venues whose <b>deadline is still ahead</b> and whose topic is a real fit, listed
  ...
  <div class="why"><b>Can you put it on arXiv first?</b> Yes, for all five. Every venue here allows
  ...
  workshop are open or non-archival, so a public preprint is completely fine.</div>
  ...
  not posted yet, so check the linked page before you plan around it. If the very near deadlines are
  too tight, the game-AI and RL conferences come back around in early to mid 2027 (IEEE CoG, RLC, and
  the next AIIDE), and they are the strongest long-term fit.</p>
  ...
  first. If June is too tight, the <b>EXAG</b> workshop at AIIDE gives a second game-AI shot at the
  same conference with a later deadline (paper August 21, 2026). Around it sit the <b>AAAI-27</b>
  student or demo track (paper July 28, 2026), the NeurIPS 2026 workshops (around late September to
  mid October 2026), and <b>AAMAS 2027</b> (paper October 8, 2026). To reach an ICML, NeurIPS, or
