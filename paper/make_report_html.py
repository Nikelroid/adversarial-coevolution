"""Generate docs/report.html: a styled HTML report.

Figures are referenced by their RAW GitHub URL (not base64), so the page stays
small (~30 KB) and renders reliably through htmlpreview.github.io -- a 2 MB
base64 page makes that proxy 404. The images load directly from
raw.githubusercontent. Run after paper/make_figures.py. Tables mirror main.tex.
"""
...
RAW = ("https://raw.githubusercontent.com/Nikelroid/adversarial-coevolution/"
       "main/paper/figures")
PDF_URL = ("https://github.com/Nikelroid/adversarial-coevolution/blob/main/"
           "paper/main.pdf")
...
<section>
  ...
  <a href="{PDF_URL}">paper/main.pdf</a>.</p>
</section>
...
def main():
    ...
    with open(OUT, "w") as f:
        f.write(HTML)
    print(f"wrote {OUT} ({len(HTML)//1024} KB of HTML, figures via raw URL)")
